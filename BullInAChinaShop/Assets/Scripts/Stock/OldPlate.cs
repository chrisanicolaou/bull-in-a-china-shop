...
namespace CharaGaming.BullInAChinaShop.Stock
{
    public class OldPlate : BaseStock
    {
        ...
        public override string[] Names { get; set; } = new[] { "Old Plate", "Old Plate 2", "Old Plate 3", "Old Plat 4e", "Old Plate 5", "Old Plate 6", };
        public override string[] FlavourTexts { get; set; } = new[] { "Old Plate", "Old Plate 2", "Old Plate 3", "Old Plat 4e", "Old Plate 5", "Old Plate 6", };
